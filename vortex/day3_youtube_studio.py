"""Build the private YouTube metadata package for FPL VORTEX Video 3/3.
...
DEFAULT_OUTPUT_ROOT = Path("/content/drive/MyDrive/FPL_VORTEX/Day_3_3")
YT_VIDEO_PART = 3
YT_VIDEO_TOTAL = 3
...
def _vx23_chapters(qa, review_gw):
    labels = {
        ...
        "gw_review": f"GW{review_gw} Gameweek Review",
        "05a_my_plan_roll": "My Plan • Roll",
        "05b_my_plan_transfer": "My Plan • Transfer",
        "05c_my_plan_free_hit": "My Plan • Free Hit",
        "05d_my_plan_wildcard": "My Plan • Wildcard",
        "05e_my_plan_roll_bb": "My Plan • Roll + Bench Boost",
        "05f_my_plan_roll_tc": "My Plan • Roll + Triple Captain",
        "05g_my_plan_transfer_bb": "My Plan • Transfer + Bench Boost",
        "05h_my_plan_transfer_tc": "My Plan • Transfer + Triple Captain",
        "02_fdr": "Benching Dilemma",
        "04_clean_sheets": "Chip Strategy",
        "05_outro": "Elite Takeaways & CTA",
    }
...
def build_youtube_studio_package(output_root):
    ...
    _day3_chapters = list(metadata.get("chapters") or [])
    _day3_hashtags = [
        "#FPL",
    ...
    metadata["title"] = (
        f"FPL GW{preview_gw} Final Team: Transfers, Bench, Chips & Captain | "
        f"GW{review_gw} Review (3/3)"
    )
    metadata["description"] = "\n".join(
        [
            f"FPL VORTEX Video 3/3 for Gameweek {preview_gw}.",
            "",
            "This final decision video covers:",
            "• Projected Goals and DEFCON",
            "• Final Shortlists and Transfer Decision Desk",
            f"• GW{review_gw} Gameweek Review and My Plan",
            "• Benching Dilemma and Chip Strategy",
            "• Elite takeaways, captaincy and final CTA",
            "",
            "CHAPTERS",
            *_day3_chapters,
            "",
    ...
    metadata["hashtags"] = _day3_hashtags
    ...
    package_path = data_dir / "youtube_video_3_of_3_package.json"
    _vx23_atomic_json(package_path, package)

    print("\n" + "=" * 74)
    print("✅ PRIVATE YOUTUBE UPLOAD PACKAGE — VIDEO 3/3")
    print("=" * 74)
