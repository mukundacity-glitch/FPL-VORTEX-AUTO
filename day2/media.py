...
# Exact proven Day 1 media contract and FFmpeg integration method. Do not tune independently.
NARRATION_LEVEL = 255
MUSIC_LEVEL = 12
...
def integrate_media(output_root: Path, asset_dir: Path) -> dict[str, Any]:
    ...
    try:
        ...
        # Match Day 1's proven post-encode MP3 QA before publishing.
    ...
    report: dict[str, Any] = {
        "version": "FPL-VORTEX-DAY2-DAY1-MEDIA-METHOD-V2",
        "passed": True,
        "isolation": {
            "day": 2,
    ...
    print("[DAY 2 MEDIA] PASS — exact Day 1 FFmpeg method")
